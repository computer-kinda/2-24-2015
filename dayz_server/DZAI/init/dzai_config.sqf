...
DZAI_dynDespawnWait = 60;

//Enable or disable dynamic spawn-free zones of 800m radius around player spawn areas. (Default: false)
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_BanditTypes = ["Ins_Soldier_Sab", "Ins_Soldier_2", "Ins_Soldier_MG", "Ins_Soldier_GL", "Ins_Soldier_Sniper"];
