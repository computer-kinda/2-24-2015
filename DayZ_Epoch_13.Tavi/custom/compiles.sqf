...
if (!isDedicated) then {
	...
	mv22_pack = compile preprocessFileLineNumbers "custom\animate\pack.sqf";
	//player_useMeds =            compile preprocessFileLineNumbers "custom\selfblood\player_useMeds.sqf";
	...
	origins_checkNeededMaterial = 	compile preprocessFileLineNumbers "custom\origins\origins_checkNeededMaterial.sqf";
	origins_removeActions = 		compile preprocessFileLineNumbers "custom\origins\origins_removeActions.sqf";
	...
	zombie_generate = 			compile preprocessFileLineNumbers "custom\walkers\zombie_generate.sqf";			//Server compile, used for loiter behaviour
	wild_spawnZombies = 		compile preprocessFileLineNumbers "custom\walkers\wild_spawnZombies.sqf";			//Server compile, used for loiter behaviour
	...
	fnc_usec_damageHandler =		compile preprocessFileLineNumbers "custom\zupa\fn_damageHandler.sqf";
